...
class _RegisterViewState extends State<RegisterView>
  ...
  Future<void> _registerUser() async {
    ...
    bool isNearby = await _isWithinIITDelhiArea();
    if (!isNearby) {
      _showError(
          "You must be near IIT Delhi Lecture Hall Complex to register.");
      return;
    }
...
For the purposes of this Privacy Policy:
    ...
    Application refers to MOBIUS, the software program provided by the Company.
    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MOBIUS.
